...
QString link("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4");
...
void launch_player()
{
    ...
    QObject::connect(player, &QMediaPlayer::videoAvailableChanged, [](bool videoAvailable){
        qDebug() << "videoAvailableChanged: " << videoAvailable;
    });
